<div class="work">
	...
	<div class="work__cont-list">
		...
		<?php include "work/kitchen.php"; ?> <!-- Кухни -->

		<?php include "work/cabinet.php"; ?> <!-- Кабинеты -->

		<?php include "work/living-room.php"; ?> <!-- Гостиные -->

		<?php include "work/bedroom.php"; ?> <!-- Спальни -->

		<?php include "work/hall.php"; ?> <!-- Прихожии -->

		<?php include "work/children.php"; ?> <!-- Детские -->

		<?php include "work/restroom.php"; ?> <!-- Ванные и санузлы -->
